...
public:
    ...
    virtual double implicit_coefficient(const std::array<double, K_ion>& u, size_t valid_u, const GatingVariables<N_ion>& vars);
    virtual double explicit_coefficient(const std::array<double, K_ion>& u, size_t valid_u, const GatingVariables<N_ion>& vars);
