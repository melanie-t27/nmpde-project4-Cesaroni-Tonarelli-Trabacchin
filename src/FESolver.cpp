...
FESolver::solve_time_step(double time)
{
  ...
  pcout << "matrix Z assemble time : " << std::chrono::duration_cast<std::chrono::microseconds>(stop1 - start1).count() << std::endl;


  auto start2 = std::chrono::high_resolution_clock::now();
  assemble_rhs(time);
  auto stop2 = std::chrono::high_resolution_clock::now();
  pcout << "rhs assemble time : " << std::chrono::duration_cast<std::chrono::microseconds>(stop2 - start2).count() << std::endl;
  ...
  pcout << "cg time : " << std::chrono::duration_cast<std::chrono::microseconds>(stop3 - start3).count() << std::endl;
